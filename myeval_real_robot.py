...
# from diffusion_policy.my_real_world.spacemouse_shared_memory import Spacemouse
from diffusion_policy.common.precise_sleep import precise_wait
from diffusion_policy.my_real_world.real_inference_util import (
...
def main(input, output, robot_ip, match_dataset, match_episode,
    ...
    with SharedMemoryManager() as shm_manager:
        with KeystrokeCounter() as kc, RealEnv(
            output_dir=output, 
            robot_ip=robot_ip, 
            frequency=frequency,
